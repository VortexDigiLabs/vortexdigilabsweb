  ...
  return (
    <button
      ...
      className={cn(
        ...
        "focus-visible:ring-2 focus-visible:ring-cyan focus-visible:ring-offset-2 rounded-lg",
        className
      )}
    ...
    >
      <div className="relative w-[72px] h-[72px]">
        ...
        <div className="absolute inset-[5px] rounded-full bg-charcoal p-[2px]">
          <div className="w-full h-full rounded-full overflow-hidden bg-silver/10">
      ...
      <span className="text-xs text-silver/70 truncate max-w-[80px]">
        {username}
      </span>
    </button>
  );
